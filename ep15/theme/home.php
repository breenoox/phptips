    ...
    <?php if(!empty($products)): foreach ($products as $product): ?>
        <article class="products_item">
            ...
            <div>
                ...
                <button class="btn_cancel" data-action="<?= $router->route("cart.remove", ["id" => $product->id]); ?>"> - </button>
            </div>
        </article>
    <?php endforeach; else: ?>
        <div class="message_error">Ainda não existem produtos cadastrados</div>
    <?php endif; ?>
</section>
...
<div class="cart_resume">
    ...
    <button class="btn_cancel" data-action="<?= $router->route("cart.clear"); ?>">Limpar</button>
